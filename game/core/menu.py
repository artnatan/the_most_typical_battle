...
from core.constants import SCREEN_HEIGHT, SCREEN_WIDTH, WHITE, BLACK
...
class Menu:
    def __init__(self, screen):
        self.screen = screen
        self.singleplayer_image = scaled_menu_images.get("SinglePlayer")
    ...
    def get_height(self):
        return (
            (SCREEN_HEIGHT - self.singleplayer_rect.height) * 0.8
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if self.singleplayer_rect.collidepoint(event.pos):
                        # Здесь вы можете добавить код для режима SinglePlayer, если нужно
                        pass
